...
import { getCurrentUser, logout as logoutApi } from '@ewa/api-client';
  ...
  useEffect(() => {
    const loadSession = () => {
      try {
        ...
        const hasAccess = currentUser && ['admin', 'operator', 'editor'].includes(currentUser.role);
      ...
      <div className="min-h-screen bg-gray-100 flex">
        ...
        <aside className="w-64 bg-white border-r border-gray-200 hidden md:flex md:flex-col md:sticky md:top-0 md:h-screen relative z-30 overflow-visible">
          ...
          <div className="p-6 flex items-center justify-center border-b border-gray-200">
            <a href="/" aria-label="Inicio" className="flex items-center justify-center">
          ...
          <div className="py-6">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="flex items-center justify-center mb-6">
                <div className="w-24 h-24 rounded-full bg-ewa-light-blue flex items-center justify-center overflow-hidden border border-gray-200 shadow-sm">
                  <BrandLogo size="lg" className="h-24 w-24" />
                </div>
              </div>
