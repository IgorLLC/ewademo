...
import { createUser } from '@ewa/api-client';
...
const NewCustomer = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(err.message || 'Error al crear el cliente. Por favor intenta nuevamente.');
    } finally {
  ...
  return (
    <AdminLayout 
      title="Nuevo Cliente" 
      description="Registro completo de nuevo cliente" 
      currentPage="users"
    >
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="mt-2 text-gray-600">Complete toda la información del cliente para el registro completo</p>
            </div>
            <button
