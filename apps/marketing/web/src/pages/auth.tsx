...
const Auth = () => {
  ...
  return (
    <>
      <Head>
        <title>{activeTab === 'login' ? 'Iniciar Sesión' : 'Registrarse'} - Agua Sustentable Demo</title>
        <meta name="description" content="Inicia sesión o regístrate en nuestro servicio de agua sustentable - Demo" />
          ...
          <div>
            <div className="flex justify-center">
              <a href="/" className="flex justify-center items-center">
                <span className="text-ewa-blue font-bold text-3xl hover:text-ewa-dark-blue transition-all duration-300">Agua Sustentable <span className="text-gray-500 text-xl">Demo</span></span>
              </a>
            </div>
