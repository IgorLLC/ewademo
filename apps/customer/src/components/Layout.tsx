            ...
            <div className="flex justify-between h-16">
              <div className="flex">
                <div className="flex-shrink-0 flex items-center">
                  <Link href={user ? '/subscriptions' : '/'} className="text-xl font-bold text-ewa-blue">
                    EWA Box Water
                  </Link>
                </div>
                {user && (
                  ...
                  <div className="ml-3 relative">
                    <div className="flex items-center">
                      ...
                      <button
                        ...
                        className="bg-white p-1 rounded-full text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-ewa-blue"
                      >
